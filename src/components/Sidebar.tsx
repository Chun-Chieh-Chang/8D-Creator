      ...
      <aside className="w-80 border-r border-(--border-color) bg-(--bg-surface) flex flex-col h-screen sticky top-0">
        ...
        <div className="p-6 border-b border-(--border-color) flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-(--accent) to-(--accent-hover) flex items-center justify-center text-white shadow-lg ring-4 ring-(--accent)/10">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="p-2.5 rounded-xl bg-(--bg-base) border border-(--border-color) text-(--text-secondary) hover:text-(--accent) hover:border-(--accent)/30 transition-all shadow-sm flex items-center justify-center w-10 h-10"
              title="品牌設定"
            >
              ...
              <div className="space-y-4 animate-in slide-in-from-top-2 duration-300">
                <div className="p-3 bg-(--accent)/5 rounded-xl border border-(--accent)/10">
                  <p className="text-[12px] text-(--text-secondary) leading-relaxed">
                    請前往 <a href="https://apihub.agnes-ai.com" target="_blank" rel="noreferrer" className="text-(--accent) font-bold hover:underline decoration-2 underline-offset-4">Agnes AI Hub</a> 取得您的 API Key。
                  </p>
                </div>
